...
However this won't allow the usage of Nextflow variables any longer in the command script.
...
IMPORTANT: Note however that the _value_ channel does not affect the process termination.
